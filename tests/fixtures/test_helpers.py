...
class StateManager:
  ...
  def add_tool_result(self, tool_name: str, result: Any) -> None:
    ...
    print(
        f'Added tool result for {tool_name} to turn'
        f' {self.current_turn.turn_number}'
    )
  ...
  def sync_from_legacy_state(self, legacy_state: Dict[str, Any]) -> None:
    ...
    self.is_new_conversation = legacy_state.get(
...
def create_mock_agent(
    name: str = 'test_agent', model: str = 'test_model'
) -> Mock:
