...
class TestRunInteractively:
    ...
    async def test_run_interactively_fallback_mode(
        ...
        mock_console.print.assert_any_call("[warning]⚠️  Enhanced UI initialization failed: UI failed[/warning]")
    ...
    async def test_run_interactively_with_thought_content(
        ...
        # Assertions
        mock_cli.format_agent_response.assert_called_once_with("Regular response", "assistant")
