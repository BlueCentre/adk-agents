...
class TestGetCliInstance:
    ...
    @patch("src.wrapper.adk.cli.utils.ui.EnhancedCLI")
    @patch("src.wrapper.adk.cli.utils.ui.RichRenderer")
    def test_get_cli_instance_with_none_theme(self, mock_rich_renderer, mock_enhanced_cli):
    ...
    @patch("src.wrapper.adk.cli.utils.ui.EnhancedCLI")
    @patch("src.wrapper.adk.cli.utils.ui.RichRenderer")
    def test_get_cli_instance_with_empty_string_theme(self, mock_rich_renderer, mock_enhanced_cli):
    ...
    @patch("src.wrapper.adk.cli.utils.ui.EnhancedCLI")
    @patch("src.wrapper.adk.cli.utils.ui.RichRenderer")
    def test_get_cli_instance_with_default_parameters(self, mock_rich_renderer, mock_enhanced_cli):
...
class TestGetTextualCliInstance:
    ...
    @patch("src.wrapper.adk.cli.utils.ui.AgentTUI")
    @patch("src.wrapper.adk.cli.utils.ui.RichRenderer")
    def test_get_textual_cli_instance_with_none_theme(self, mock_rich_renderer, mock_agent_tui):
