...
class LearningSystem:
    ...
    def get_suggestions(
        self, original_command: str, error_type: str, context_keywords: list[str]
    ) -> list[str]:
        ...
        for _key, data in self.learned_patterns.items():
        ...
        sorted_relevant = sorted(
            relevant_suggestions.items(), key=lambda item: item[1], reverse=True
        )
