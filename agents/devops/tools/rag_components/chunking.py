    ...
    try:
        ...
        for node in tree.body:
            ...
            if chunk_content is None: 
                ...
                chunk_content = "\n".join(lines[start_line-1:node_end_lineno]) if node_end_lineno else lines[start_line-1]
            ...
            if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)):
                ...
                if not chunks or chunks[-1]["type"] not in ["module-level-block"] or chunks[-1]["end_line"] != start_line -1 :
                    chunks.append({
                        "file_path": file_path,
                    ...
                    chunks[-1]["name"] = f"module-level-block_{chunks[-1]['start_line']}-{actual_end_line}"
