...
def display_model_usage(
    console: Console, prompt_tokens: Any, completion_tokens: Any, total_tokens: Any
):
...
def display_model_usage_with_thinking(
    console: Console,
    prompt_tokens: Any,
...
def display_tool_error_with_suggestions(
    ...
    try:
        ...
        if suggestions:
            content_parts.append(
                f"[blue][b]Additional Suggestions:[/b] {len(suggestions)} available[/blue]"
            )
